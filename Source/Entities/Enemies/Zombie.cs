...
namespace GameProject.Source.Entities.Enemies
{
	class Zombie : Enemy
    {
        ...
        public Zombie(Vector2 POS, Vector2 DIMS, Vector2 target) : base(POS, DIMS)
        {
            this.target = target;
            ...
            current_animation = animMgr.GetAnimation("zombie_down_"+skin);
        ...
        public override void Update(GameTime gameTime)
		{
            ...
            collider.cm.AssignToSpatialDivision(collider);
		...
		private void Move(GameTime gameTime)
		{
			...
			{
				current_animation = animMgr.GetAnimation("zombie_" + moveY + "_" + skin);
			}
			else
			{
				current_animation = animMgr.GetAnimation("zombie_" + moveX + "_" + skin);
			}
		}
